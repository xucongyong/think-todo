...
all your steps. **Run `bd ready` to see them.** Follow steps until `gt done`.

**Work hooked → `bd ready` → Follow steps → `gt done`.**

**No thinking. No "should I?" questions. Hook → `bd ready` → Execute.**
